...
{: caption="Table 2. Commands for managing import tokens" caption-side="top"}
{: #table-2}
...
<dl>
    ...
    <dt><code>-n, --encrypted-nonce</code></dt>
        ...
        <p>To retrieve a nonce, use <code>ibmcloud kp import-token create</code> to create an import token and <code>ibmcloud kp import-token show</code>. Then, encrypt the value by running <code>ibmcloud kp import-token nonce-encrypt</code>.</p>
        </dd>
...
<dl>
   <dt><code>KEY_ID</code></dt>
        <dd>The ID of the key that you want to retrieve. To retrieve a list of your available keys, run the <a href="#kp-keys">kp keys</a> command.</dd>
    <dt><code>-i, --instance-ID</code></dt>
        <dd>The {{site.data.keyword.cloud_notm}} instance ID that identifies your {{site.data.keyword.keymanagementserviceshort}} service instance.</dd>
</dl>
...
```
ibmcloud kp key unwrap ROOT_KEY_ID -i $INSTANCE_ID 
...
```
ibmcloud kp key rotate ROOT_KEY_ID -i $INSTANCE_ID
                 [-k, --key-material $KEY_MATERIAL] 
```
{: pre}
...
<dl>
   <dt><code>KEY_ID</code></dt>
   <dd>The ID of the key that you want to delete. To retrieve a list of your available keys, run the <a href="#kp-keys">kp keys</a> command.</dd>
    <dt><code>-i, --instance-ID</code></dt>
        <dd>The {{site.data.keyword.cloud_notm}} instance ID that identifies your {{site.data.keyword.keymanagementserviceshort}} service instance.</dd>
</dl>
...
```
ibmcloud kp key policy-update ROOT_KEY_ID -i $INSTANCE_ID
...
### Required parameters
{: #key-policy-update-req-params}

<dl>
   <dt><code>ROOT_KEY_ID</code></dt>
        <dd>The ID of the root key that you want to query. To retrieve a list of your available keys, run the <a href="#kp-keys">kp keys</a> command.</dd>
...
```
ibmcloud kp policies KEY_ID -i $INSTANCE_ID
```
{: pre}

### Required parameters
{: #key-policies-req-params}

<dl>
   <dt><code>KEY_ID</code></dt>
        <dd>The ID of the key that you want to query. To retrieve a list of your available keys, run the <a href="#kp-keys">kp keys</a> command.</dd>
    <dt><code>-i, --instance-ID</code></dt>
        <dd>The {{site.data.keyword.cloud_notm}} instance ID that identifies your {{site.data.keyword.keymanagementserviceshort}} service instance.</dd>
</dl>

### Optional parameters
{: #key-policies-opt-params}
...
### Required parameters
{: #import-token-nonce-encrypt-req-params}
...
### Optional parameters
{: #import-token-nonce-encrypt-opt-params}
...
### Required parameters
{: #import-token-key-encrypt-req-params}
...
### Optional parameters
{: #import-token-key-encrypt-opt-params}
